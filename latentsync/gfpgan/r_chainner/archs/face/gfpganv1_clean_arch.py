...
class GFPGANv1Clean(nn.Module):
    ...
    # def face_enhance(self, res_frame):
    ...
    #     output = self.facerestore_model(cropped_face_t)[0]
    #     cropped_face = tensor2img(
    #         output, rgb2bgr=True, min_max=(-1, 1)
    #     )
    #     res_frame = (
    #         res_frame * (1 - self.face_restore_visibility)
    #         + cropped_face * self.face_restore_visibility
    #     )
    #     res_frame = cv2.resize(
    #                 res_frame.astype(np.uint8), (height, width)
    #             )
    #     return res_frame